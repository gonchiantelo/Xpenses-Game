      ...
      <div className="auth-container">
        ...
        <div className="auth-card">
          ...
          <div className="social-buttons">
            <button id="btn-google" className="btn btn--secondary social-btn">
            ...
            <button id="btn-outlook" className="btn btn--secondary social-btn">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <p className="auth-signup-link">
          ¿No tenés cuenta?{' '}
          <Link href="/register" className="auth-link auth-link--accent">
            Crear cuenta gratis
          </Link>
        </p>
      </div>
